...
const defaultBlogPosts: BlogPost[] = [
  {
    id: 1, slug: "the-art-of-perfect-pasta-secrets-from-italian-grandmothers",
  ...
  },
  {
    ...
    author: { name: "Sarah Chen", image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah", bio: "Head Chef & Blogger, specializing in seasonal farm-to-table cooking." },
...
function ReadingProgress() {
  ...
  return <motion.div style={{ scaleX }} className="fixed top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-primary via-accent to-primary origin-left z-[100] shadow-sm shadow-primary/40" />;
}
                  ...
                  <div className="p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row gap-5 items-center sm:items-start">
                      ...
                      <div className="relative shrink-0">
                        ...
                        <div className="absolute -bottom-2 -right-2 w-7 h-7 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center shadow-md">
                    ...
                    {!subscribed ? (
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-primary to-accent text-primary-foreground text-xs font-black uppercase tracking-wider py-2.5 rounded-xl hover:shadow-lg hover:shadow-primary/25 transition-all"
                        >
                          Subscribe Now →
                        </button>
                      </div>
