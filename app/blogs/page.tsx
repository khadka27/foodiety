...
export default function BlogsPage() {
 ...
 Stories & <span className="text-[#c05c31] dark:text-[#ebc63c]">Recipes</span>
 </h1>
 ...
 <motion.div
 layoutId="cat-pill"
 className="absolute inset-0 bg-[#c05c31] rounded-full -z-10"
 ...
 className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#c05c31] hover:bg-[#a64b25] text-primary-foreground text-sm font-bold rounded-xl hover:shadow-lg hover:shadow-primary/25 transition-all"
 >
 Reset Filters
 </button>
 </motion.div>
 ...
 />
 {/* Overlays */}
 <div className="absolute inset-0 /90 /55 /10" />
 ...
 className="w-full bg-[#c05c31] hover:bg-[#a64b25] text-primary-foreground text-xs font-black uppercase tracking-wider py-2.5 rounded-xl hover:shadow-lg hover:shadow-primary/25 transition-all duration-300"
 >
 Subscribe Free →
 </button>
 </div>
 ...
 <h2 className="text-3xl md:text-4xl font-bold font-playfair text-foreground leading-tight">
 Never Miss a<br />
 <span className="text-[#c05c31] dark:text-[#ebc63c]">Food Story</span>
 </h2>
 ...
 className="flex-1 px-4 py-3 text-sm border border-border/60 bg-background/80 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#c05c31]/30 focus:border-primary transition-all"
 />
 <button className="px-5 py-3 bg-[#c05c31] hover:bg-[#a64b25] text-primary-foreground text-sm font-black rounded-xl hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 whitespace-nowrap flex items-center gap-2">
