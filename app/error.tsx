...
export default function Error({ error, reset }: ErrorProps) {
 ...
 return (
 <div className="min-h-screen dark:/20 dark:/20 dark:/20 flex items-center justify-center p-4 relative overflow-hidden">
 {/* Background Pattern */}
 ...
 className="text-6xl md:text-7xl font-bold bg-clip-text text-transparent mb-4"
 >
 500
 </motion.div>
 </div>
