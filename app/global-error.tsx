...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
 ...
 <button
 onClick={reset}
 className=" hover: hover: text-white px-8 py-3 rounded-full font-semibold transition-all duration-200 hover:scale-105 shadow-lg flex items-center space-x-2"
 >
