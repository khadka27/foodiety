...
import { Clock, Users, Star, Heart, Bookmark, ArrowLeft, Check, Plus, Minus } from 'lucide-react';
...
const recipe = {
  ...
  image: 'https://images.pexels.com/photos/2762942/pexels-photo-2762942.jpeg?auto=compress&cs=tinysrgb&w=1200',
  difficulty: 'Beginner',
  cookTime: '30 min',
  prepTime: '15 min',
  servings: 4,
  ...
  description: 'A classic Italian pizza with fresh tomatoes, mozzarella, and basil – simple ingredients that create an extraordinary flavor experience.',
  calories: 285,
  nutrition: {
    protein: '12g',
    carbs: '35g',
  ...
  ingredients: [
    ...
    { item: 'San Marzano tomatoes', amount: '1 can (14 oz)', category: 'sauce' },
  ...
  instructions: [
    {
      step: 1,
      instruction: 'Preheat your oven to 475°F (245°C). If you have a pizza stone, place it in the oven while preheating.',
      time: '15 min',
    },
    {
      step: 2,
      instruction: 'Prepare the sauce by crushing the San Marzano tomatoes by hand and mixing with minced garlic, salt, and a drizzle of olive oil.',
      time: '5 min',
    },
    {
      step: 3,
      instruction: 'Roll out the pizza dough on a floured surface to your desired thickness. Transfer to a pizza pan or parchment paper.',
      time: '5 min',
    },
    {
      step: 4,
      instruction: 'Spread the tomato sauce evenly over the dough, leaving a 1-inch border for the crust.',
      time: '2 min',
    },
    {
      step: 5,
      instruction: 'Tear the fresh mozzarella into small pieces and distribute evenly over the sauce.',
      time: '3 min',
    },
    {
      step: 6,
      instruction: 'Bake for 12-15 minutes until the crust is golden and the cheese is bubbly and slightly browned.',
      time: '15 min',
    },
    {
      step: 7,
      instruction: 'Remove from oven and immediately top with fresh basil leaves and a final drizzle of olive oil. Slice and serve hot.',
      time: '2 min',
    },
  ],
};
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  <Badge className="bg-green-100 text-green-800">{recipe.difficulty}</Badge>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500">({recipe.reviews} reviews)</div>
                  </div>
                  <div className="text-center">
                    <div className="text-sm font-medium text-gray-900">{recipe.calories}</div>
                ...
                <div className="flex space-x-4">
                  <Button
                    ...
                    className={isFavorited ? 'bg-red-600 hover:bg-red-700' : 'border-red-200 text-red-600 hover:bg-red-50'}
                  >
                  ...
                  <div className="space-y-6">
                    {recipe.instructions.map((instruction) => (
                      <div key={instruction.step} className="flex items-start space-x-4">
                        <Button
                          variant={completedSteps.has(instruction.step) ? 'default' : 'outline'}
                          size="sm"
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        <span>Calories</span>
                        <span className="font-bold">{Math.round(recipe.calories * servingMultiplier)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Protein</span>
