...
const restaurants = [
  {
    ...
    description:
      "Authentic Italian dining with handmade pasta and traditional recipes passed down through generations.",
    distance: "0.5 miles",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Vibrant Mexican street food with authentic flavors and fresh, locally-sourced ingredients.",
    distance: "2.1 miles",
  },
  {
    id: 4,
    ...
    description:
      "Classic French bistro atmosphere with expertly prepared traditional dishes and excellent wines.",
    distance: "0.8 miles",
  },
  {
    id: 5,
    ...
    description:
      "Fresh Mediterranean cuisine focusing on healthy, flavorful dishes with premium olive oils.",
    distance: "1.5 miles",
  },
  {
    id: 6,
    ...
    description:
      "Aromatic Indian cuisine with traditional spices and modern presentation techniques.",
    distance: "3.2 miles",
  },
];
...
export default function RestaurantsPage() {
  ...
  const filteredRestaurants = restaurants.filter((restaurant) => {
    ...
    const matchesPrice =
      selectedPrice === "All Prices" || restaurant.priceRange === selectedPrice;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-red-100 max-w-2xl mx-auto">
              ...
              Each one is selected for quality, authenticity, and exceptional
              dining experiences.
            </p>
          </motion.div>
        </div>
              ...
              <CardContent className="p-0">
                <div className="bg-gray-100 h-96 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-sm">
                      Map integration would be implemented here with your
