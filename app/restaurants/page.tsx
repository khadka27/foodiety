...
const categories = [
  { id: "all", label: "All Hubs", icon: Sparkles },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <div className="pt-4 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              {[
                { label: "Restaurants", value: establishments.filter(e => e.category === "restaurant").length },
                { label: "Boutique Cafes", value: establishments.filter(e => e.category === "cafe").length },
                { label: "Luxury Hotels", value: establishments.filter(e => e.category === "hotel").length },
                  ...
                  <form onSubmit={handleReviewSubmit} className="space-y-4">
                    ...
                    <div className="flex space-x-3 pt-4 border-t border-border/30">
                      ...
                      <Button
                        type="submit"
                        disabled={isSubmitting}
                        className="flex-1 rounded-xl py-6 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white text-xs font-bold shadow-lg shadow-orange-500/10"
                      >
                        {isSubmitting ? (
