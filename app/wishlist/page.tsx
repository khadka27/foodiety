        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-red-100 max-w-2xl mx-auto">
              Your saved recipes and restaurants all in one place. 
              Never lose track of the dishes and places you want to try!
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {wishlistItems.length === 0 ? (
            ...
            >
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                Start exploring our recipes and restaurants to build your personal collection of favorites.
              </p>
                      ...
                      >
                        <Card className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg overflow-hidden h-full">
                          <div className="relative overflow-hidden">
                            <img
                              src={item.recipe?.image || 'https://images.pexels.com/photos/2762942/pexels-photo-2762942.jpeg?auto=compress&cs=tinysrgb&w=800'}
                            ...
                            <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full flex items-center space-x-1">
                              ...
                              <span className="text-xs font-medium text-gray-700">{item.recipe?.rating || 0}</span>
                            </div>
                          </div>
                          ...
                          <CardContent className="p-6 flex-1 flex flex-col">
                            ...
                            <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                              <div className="flex items-center space-x-1">
                                ...
                                <span>{item.recipe?.cookTime || 0} min</span>
                              </div>
                            ...
                            <Button asChild className="w-full bg-red-600 hover:bg-red-700 mt-auto">
                    ...
                    {restaurantItems.map((item, index) => (
                      ...
                      >
                        <Card className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg overflow-hidden h-full">
                          <div className="relative overflow-hidden">
                            <img
                              src={item.restaurant?.image || 'https://images.pexels.com/photos/3184306/pexels-photo-3184306.jpeg?auto=compress&cs=tinysrgb&w=800'}
                              alt={item.restaurant?.name}
                              className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300"
                            />
                            <div className="absolute top-4 left-4">
                              <Badge className="bg-white/90 text-gray-700">{item.restaurant?.category}</Badge>
                            </div>
                            <div className="absolute top-4 right-4">
                              <WishlistButton
                                type="restaurant"
                            ...
                            <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full flex items-center space-x-1">
                              <Star className="h-3 w-3 text-yellow-500 fill-current" />
                              <span className="text-xs font-medium text-gray-700">{item.restaurant?.rating || 0}</span>
                            </div>
                          </div>
