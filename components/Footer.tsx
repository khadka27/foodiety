...
export function Footer() {
  ...
  return (
    <footer className="relative bg-background border-t border-border/60 overflow-hidden mt-0">
      ...
      <div className="absolute top-0 left-1/4 w-80 h-80 bg-orange-500/5 rounded-full blur-[100px] animate-blob pointer-events-none -z-0" />
      <div className="absolute top-0 right-1/4 w-80 h-80 bg-red-500/5 rounded-full blur-[100px] animate-blob animation-delay-2000 pointer-events-none -z-0" />

      {/* Newsletter Banner */}
      <div className="relative z-10 border-b border-border/60 bg-gradient-to-r from-orange-50/60 to-red-50/40 dark:from-orange-950/20 dark:to-red-950/10">
