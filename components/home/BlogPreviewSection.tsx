        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {blogPosts.map((post, index) => {
            ...
            return (
              ...
              >
                <article className="glass-card rounded-3xl overflow-hidden border border-white/20 dark:border-white/5 h-full flex flex-col hover:-translate-y-2 hover:shadow-2xl transition-all duration-400">
                  {/* Image */}
