...
export function ContactCTASection() {
 ...
 {/* Animated orbs */}
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-white/10 dark:bg-white/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4 pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-amber-400/20 dark:bg-amber-800/10 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/4 pointer-events-none" />
 ...
 <div className="w-6 h-6 rounded-full flex items-center justify-center text-white text-[10px] font-bold">A</div>
