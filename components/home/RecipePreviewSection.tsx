                ...
                <div className="glass-card rounded-3xl overflow-hidden border border-white/20 dark:border-white/5 h-full flex flex-col hover:-translate-y-2 hover:shadow-2xl transition-all duration-400">
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <Link
                      ...
                      className="mt-auto w-full py-2.5 rounded-xl text-sm font-semibold text-center transition-all duration-300 bg-gradient-to-r from-orange-500 to-red-500 text-white hover:shadow-lg hover:shadow-orange-500/30 hover:scale-[1.02] flex items-center justify-center gap-2"
                    >
