...
const fallbackDesigns = [
  { color: 'from-orange-500 to-red-500', iconBg: 'from-orange-50 to-red-50 dark:from-orange-950/40 dark:to-red-950/40', glow: 'shadow-orange-500/20' },
  { color: 'from-amber-500 to-orange-500', iconBg: 'from-amber-50 to-orange-50 dark:from-amber-950/40 dark:to-amber-950/40', glow: 'shadow-amber-500/20' },
  { color: 'from-green-500 to-teal-500', iconBg: 'from-green-50 to-teal-50 dark:from-green-950/40 dark:to-teal-950/40', glow: 'shadow-green-500/20' },
  { color: 'from-blue-500 to-purple-500', iconBg: 'from-blue-50 to-purple-50 dark:from-blue-950/40 dark:to-purple-950/40', glow: 'shadow-blue-500/20' },
];
