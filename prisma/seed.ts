import { PrismaClient, Role, RecipeCategory, RestaurantCategory } from '@prisma/client';
  ...
  const restaurants = [
    {
      name: 'Bella Notte',
      slug: 'bella-notte',
      description: 'Authentic Italian dining with handmade pasta and traditional recipes',
  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Discover the time-honored techniques that make Italian pasta truly exceptional',
